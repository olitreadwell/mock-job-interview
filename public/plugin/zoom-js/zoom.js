...
(function () {
  ...
  document.querySelector('.reveal .slides').addEventListener('mousedown', (event) => {
  ...
  Reveal.addEventListener('overviewshown', () => { isEnabled = false; });
  Reveal.addEventListener('overviewhidden', () => { isEnabled = true; });
}());
