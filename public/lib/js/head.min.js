/*! head.core - v1.0.2 */
(function (n, t) {
  function r(n) { a[a.length] = n; } function k(n) { const t = new RegExp(` ?\\b${n}\\b`); c.className = c.className.replace(t, ''); } function p(n, t) { for (let i = 0, r = n.length; i < r; i++)t.call(n, n[i], i); } function tt() {
    let t,
      e,
      f,
      o; c.className = c.className.replace(/ (w-|eq-|gt-|gte-|lt-|lte-|portrait|no-portrait|landscape|no-landscape)\d+/g, ''); t = n.innerWidth || c.clientWidth; e = n.outerWidth || n.screen.width; u.screen.innerWidth = t; u.screen.outerWidth = e; r(`w-${t}`); p(i.screens, (n) => { t > n ? (i.screensCss.gt && r(`gt-${n}`), i.screensCss.gte && r(`gte-${n}`)) : t < n ? (i.screensCss.lt && r(`lt-${n}`), i.screensCss.lte && r(`lte-${n}`)) : t === n && (i.screensCss.lte && r(`lte-${n}`), i.screensCss.eq && r(`e-q${n}`), i.screensCss.gte && r(`gte-${n}`)); }); f = n.innerHeight || c.clientHeight; o = n.outerHeight || n.screen.height; u.screen.innerHeight = f; u.screen.outerHeight = o; u.feature('portrait', f > t); u.feature('landscape', f < t);
  } function it() { n.clearTimeout(b); b = n.setTimeout(tt, 50); } var y = n.document,
    rt = n.navigator,
    ut = n.location,
    c = y.documentElement,
    a = [],
    ...
    nt,
    e,
    b; if (n.head_conf) for (v in n.head_conf)n.head_conf[v] !== t && (i[v] = n.head_conf[v]); u = n[i.head] = function () { u.ready.apply(null, arguments); }; u.feature = function (n, t, i) { return n ? (Object.prototype.toString.call(t) === '[object Function]' && (t = t.call()), r((t ? '' : 'no-') + n), u[n] = !!t, i || (k(`no-${n}`), k(n), u.feature()), u) : (c.className += ` ${a.join(' ')}`, a = [], u); }; u.feature('js', !0); s = rt.userAgent.toLowerCase(); w = /mobile|android|kindle|silk|midp|phone|(windows .+arm|touch)/.test(s); u.feature('mobile', w, !0); u.feature('desktop', !w, !0); s = /(chrome|firefox)[ \/]([\w.]+)/.exec(s) || /(iphone|ipad|ipod)(?:.*version)?[ \/]([\w.]+)/.exec(s) || /(android)(?:.*version)?[ \/]([\w.]+)/.exec(s) || /(webkit|opera)(?:.*version)?[ \/]([\w.]+)/.exec(s) || /(msie) ([\w.]+)/.exec(s) || /(trident).+rv:(\w.)+/.exec(s) || []; o = s[1]; h = parseFloat(s[2]); switch (o) { case 'msie':case 'trident':o = 'ie'; h = y.documentMode || h; break; case 'firefox':o = 'ff'; break; case 'ipod':case 'ipad':case 'iphone':o = 'ios'; break; case 'webkit':o = 'safari'; } for (u.browser = { name: o, version: h }, u.browser[o] = !0, l = 0, d = i.browsers.length; l < d; l++) for (f in i.browsers[l]) if (o === f) for (r(f), g = i.browsers[l][f].min, nt = i.browsers[l][f].max, e = g; e <= nt; e++)h > e ? (i.browserCss.gt && r(`gt-${f}${e}`), i.browserCss.gte && r(`gte-${f}${e}`)) : h < e ? (i.browserCss.lt && r(`lt-${f}${e}`), i.browserCss.lte && r(`lte-${f}${e}`)) : h === e && (i.browserCss.lte && r(`lte-${f}${e}`), i.browserCss.eq && r(`eq-${f}${e}`), i.browserCss.gte && r(`gte-${f}${e}`)); else r(`no-${f}`); r(o); r(o + parseInt(h, 10)); i.html5 && o === 'ie' && h < 9 && p('abbr|article|aside|audio|canvas|details|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|progress|section|summary|time|video'.split('|'), (n) => { y.createElement(n); }); p(ut.pathname.split('/'), function (n, u) {
...
/*! head.css3 - v1.0.0 */
(function (n, t) {
  function a(n) { for (const r in n) if (i[n[r]] !== t) return !0; return !1; } function r(n) {
    let t = n.charAt(0).toUpperCase() + n.substr(1),
    ...
    u = n[l],
    f = { gradient() { const n = 'background-image:'; return i.cssText = (n + s.join(`gradient(linear,left top,right bottom,from(#9f9),to(#fff));${n}`) + s.join(`linear-gradient(left top,#eee,#fff);${n}`)).slice(0, -n.length), !!i.backgroundImage; },
      rgba() { return i.cssText = 'background-color:rgba(0,0,0,0.5)', !!i.backgroundColor; },
      opacity() { return o.style.opacity === ''; },
      textshadow() { return i.textShadow === ''; },
      multiplebgs() { i.cssText = 'background:url(https://),url(https://),red url(https://)'; const n = (i.background || '').match(/url/g); return Object.prototype.toString.call(n) === '[object Array]' && n.length === 3; },
      boxshadow() { return r('boxShadow'); },
      borderimage() { return r('borderImage'); },
      borderradius() { return r('borderRadius'); },
      cssreflections() { return r('boxReflect'); },
      csstransforms() { return r('transform'); },
      csstransitions() { return r('transition'); },
      touch() { return 'ontouchstart' in n; },
      retina() { return n.devicePixelRatio > 1; },
      fontface() {
        let t = u.browser.name,
          n = u.browser.version; switch (t) { case 'ie':return n >= 9; case 'chrome':return n >= 13; case 'ff':return n >= 6; case 'ios':return n >= 5; case 'android':return !1; case 'webkit':return n >= 5.1; case 'opera':return n >= 10; default:return !1; }
      } }; for (const e in f)f[e] && u.feature(e, f[e].call(), !0); u.feature();
}(window));
/*! head.load - v1.0.3 */
(function (n, t) {
  function w() {} function u(n, t) { if (n) { typeof n === 'object' && (n = [].slice.call(n)); for (let i = 0, r = n.length; i < r; i++)t.call(n, n[i], i); } } function it(n, i) { const r = Object.prototype.toString.call(i).slice(8, -1); return i !== t && i !== null && r === n; } function s(n) { return it('Function', n); } function a(n) { return it('Array', n); } function et(n) {
    ...
    let f = typeof n === 'object' ? n : { test: n, success: !t ? !1 : a(t) ? t : [t], failure: !r ? !1 : a(r) ? r : [r], callback: u || w },
  ...
  tt = 3,
  l = 4,
  p; if (r.readyState === 'complete')e(); else if (r.addEventListener)r.addEventListener('DOMContentLoaded', k, !1), n.addEventListener('load', e, !1); else { r.attachEvent('onreadystatechange', k); n.attachEvent('onload', e); p = !1; try { p = !n.frameElement && r.documentElement; } catch (wt) {}p && p.doScroll && (function pt() { if (!o) { try { p.doScroll('left'); } catch (t) { n.clearTimeout(i.readyTimeout); i.readyTimeout = n.setTimeout(pt, 50); return; }e(); } }()); }i.load = i.js = ut ? lt : ct; i.test = ot; i.ready = yt; i.ready(r, () => { y() && u(h.ALL, (n) => { f(n); }); i.feature && i.feature('domloaded', !0); });
}(window));
/*
